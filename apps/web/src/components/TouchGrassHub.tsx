...
const BREAK_CARDS = [
  ...
  {
    href: 'https://freecash.com/r/jmenichole',
    external: true,
    step: '02',
    title: 'FreeCash surveys & games',
    copy: 'Side quests that pay — surveys and app offers, not casino tabs.',
  },
  {
    href: 'https://earnlab.com/games/jmenichole',
    external: true,
    step: '03',
    title: 'EarnLab offers & surveys',
    copy: 'Games and paid offers while the lockout runs — same vibe, zero house edge.',
  },
  {
    href: 'https://dashboard.babel.audio/',
    external: true,
    step: '04',
    title: 'Babel Audio',
    copy: 'Get paid to record voice tasks for AI — flexible gigs, weekly payouts.',
  },
  {
    href: 'https://transperfect.wd5.myworkdayjobs.com/transperfect',
    external: true,
    step: '05',
    title: 'TransPerfect jobs',
    copy: 'Remote translation and language roles — paycheck energy, not slot spin energy.',
  },
  {
    ...
    step: '06',
    title: 'freeCodeCamp',
    copy: 'Learn to code for free. Build something instead of chasing losses.',
  },
  {
    href: 'https://pll.harvard.edu/catalog/free',
    external: true,
    step: '07',
    title: 'Harvard free courses',
    copy: 'Ivy League lectures and certs at no cost. Upgrade your brain, not the bet.',
  },
  {
